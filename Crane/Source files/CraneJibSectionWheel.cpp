...
CraneJibSectionWheel::CraneJibSectionWheel(const Shader& shader,  const char* verticesPath, const char* indicesPath,glm::vec4 color)
...
void CraneJibSectionWheel::render(glm::mat4 view, float zoom, glm::vec3 light)
{
